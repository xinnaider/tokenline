...
- 9bd1d78: Rework `install.sh` into an interactive installer. It now copies `tokenline.sh`
...
- 0d28798: Add macOS support. `tokenline.sh` now abstracts `date`/`stat` over GNU vs BSD by
